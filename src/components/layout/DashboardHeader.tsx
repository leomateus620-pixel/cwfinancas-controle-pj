        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 rounded-lg">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="cursor-pointer text-sm gap-2" onClick={() => navigate("/settings")}>
                <Settings className="w-4 h-4" />
                Configurações
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem className="text-destructive cursor-pointer text-sm gap-2" onClick={() => signOut()}>
