...
import { TrendingDown, FileText, Eye, EyeOff } from "lucide-react";
    ...
    <div className="liquid-glass-card rounded-2xl p-6 border-l-4 border-l-amber-400 relative">
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-xl bg-amber-500/10 backdrop-blur-sm border border-amber-400/20 shadow-[0_0_12px_-3px_hsla(38,92%,50%,0.2)]">
        ...
        {records.length === 0 ? (
          ...
          <div className="max-h-[400px] overflow-auto rounded-xl border border-border/40 bg-background/40 backdrop-blur-sm">
            <Table>
              ...
              <TableBody>
                {records.map((r) => (
                  <TableRow key={r.id} className="text-sm hover:bg-amber-50/30 transition-colors border-b border-border/20">
